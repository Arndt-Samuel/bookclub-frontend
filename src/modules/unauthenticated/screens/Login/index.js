            ...
            <Flex
                ...
                h='100%'>
                    <Flex flexDir='column' w={['100%', '100%', '100%', '416px']} >
                        ...
                        <Button onClick={handleSubmit} mb='12px' mt='24px'>Entrar</Button>
                        <Link.Action onClick={() => navigate('/signup')} mt='8px' text='Não possui uma conta?' actionText='Cadastre-se aqui.'></Link.Action>
                    </Flex>
            </Flex>
            <Flex
                w={['0%', '0%', '0%', '60%']}
